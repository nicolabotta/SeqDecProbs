...
if (i == 0 && j < nc - 1 - 3) fill(A--B--C--D--A--cycle, lightcyan);
if (i == 1 && j < nc - 1 - 2) fill(A--B--C--D--A--cycle, lightcyan);
if (i == 2 && j < nc - 1 - 1) fill(A--B--C--D--A--cycle, lightcyan);
if (i == 3 && j < nc - 1) fill(A--B--C--D--A--cycle);
if (i == 5 && j > nc - 3 + 1) fill(A--B--C--D--A--cycle, lightcyan);
