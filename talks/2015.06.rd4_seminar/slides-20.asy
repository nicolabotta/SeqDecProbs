...
if (i == 6 && j < nc - 1 - 3) fill(A--B--C--D--A--cycle, lightmagenta);
if (i == 5 && j < nc - 1 - 2) fill(A--B--C--D--A--cycle, lightmagenta);
if (i == 4 && j < nc - 1 - 1) fill(A--B--C--D--A--cycle, lightmagenta);
if (i == 3 && j < nc - 1) fill(A--B--C--D--A--cycle);
if (i == 7 && j > nc - 3 + 1) fill(A--B--C--D--A--cycle, lightmagenta);
