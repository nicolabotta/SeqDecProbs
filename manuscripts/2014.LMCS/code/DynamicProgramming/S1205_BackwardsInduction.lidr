...
>   p : Policy t (S n)
>   p x r v = yq where
>     yq : (y : Ctrl t x ** Viable {t = S t} n (step t x y))
...
>   x1' : State (S t)
>   x1' = step t x y1
>   r1' : Reachable {t = S t} x1'
>   r1' = reachableSpec1 x r y1
>   v1' : Viable {t = S t} n x1'
>   v1' = outr (p' x r v)
>   oy : Ctrl t x
>   oy = outl ((optExtension t n ps) x r v)
>   ox' : State (S t)
>   ox' = step t x oy
>   or' : Reachable {t = S t} ox'
>   or' = reachableSpec1 x r oy
>   ov' : Viable {t = S t} n ox'
>   ov' = outr ((optExtension t n ps) x r v)
>   step1234 : p' x r v =
>               MkDPair
>               {P = \ fresh_y  =>
>                      Viable {t = S t} n (step t x fresh_y)}
>               y1 v1'
