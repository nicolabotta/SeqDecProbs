...
We re-implement 'S1206_Example2.lidr' with |M = Identity|
...
>   if column {t} x == 0 || column {t} x == maxColumn 
>     then True
...
> Reachability.reachableSpec2 x' rx' = believe_me oh
...
> Viability.viableSpec1 {t = t} x v = ((a ** believe_me oh) ** believe_me oh)
>   where
>     a : Action
...
> admissiblesP {t} {n} x v = filterTagP (admissible x) (outr s1) s6 where 
